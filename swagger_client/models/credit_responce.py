...
class CreditResponce(object):
    ...
    def __init__(self, status=None, data=None):  # noqa: E501
        """CreditResponce - a model defined in Swagger"""  # noqa: E501
        self._status = None
        self._data = None
    ...
    @property
    def status(self):
        """Gets the status of this CreditResponce.  # noqa: E501


        :return: The status of this CreditResponce.  # noqa: E501
        :rtype: bool
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this CreditResponce.


        :param status: The status of this CreditResponce.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def data(self):
        """Gets the data of this CreditResponce.  # noqa: E501


        :return: The data of this CreditResponce.  # noqa: E501
        :rtype: Credit
        """
        return self._data
    ...
    @data.setter
    def data(self, data):
        """Sets the data of this CreditResponce.


        :param data: The data of this CreditResponce.  # noqa: E501
        :type: Credit
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CreditResponce, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreditResponce):
            return False
