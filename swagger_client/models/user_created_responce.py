...
class UserCreatedResponce(object):
    ...
    def __init__(self, status=None, data=None):  # noqa: E501
        """UserCreatedResponce - a model defined in Swagger"""  # noqa: E501
        self._status = None
        self._data = None
    ...
    @property
    def status(self):
        """Gets the status of this UserCreatedResponce.  # noqa: E501


        :return: The status of this UserCreatedResponce.  # noqa: E501
        :rtype: bool
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this UserCreatedResponce.


        :param status: The status of this UserCreatedResponce.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def data(self):
        """Gets the data of this UserCreatedResponce.  # noqa: E501


        :return: The data of this UserCreatedResponce.  # noqa: E501
        :rtype: User
        """
        return self._data
    ...
    @data.setter
    def data(self, data):
        """Sets the data of this UserCreatedResponce.


        :param data: The data of this UserCreatedResponce.  # noqa: E501
        :type: User
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(UserCreatedResponce, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UserCreatedResponce):
            return False
