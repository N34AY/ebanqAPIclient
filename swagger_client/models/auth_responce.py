...
class AuthResponce(object):
    ...
    def __init__(self, status=None, token=None):  # noqa: E501
        """AuthResponce - a model defined in Swagger"""  # noqa: E501
        self._status = None
        self._token = None
    ...
    @property
    def status(self):
        """Gets the status of this AuthResponce.  # noqa: E501


        :return: The status of this AuthResponce.  # noqa: E501
        :rtype: bool
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this AuthResponce.


        :param status: The status of this AuthResponce.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def token(self):
        """Gets the token of this AuthResponce.  # noqa: E501


        :return: The token of this AuthResponce.  # noqa: E501
        :rtype: str
        """
        return self._token
    ...
    def token(self, token):
        """Sets the token of this AuthResponce.


        :param token: The token of this AuthResponce.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AuthResponce, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AuthResponce):
            return False
