...
class SessionsApi(object):
    ...
    def close_operation(self, session_id, **kwargs):  # noqa: E501
        """Close session  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.close_operation(session_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str session_id: id active session (required)
        ...
        if kwargs.get('async_req'):
            return self.close_operation_with_http_info(session_id, **kwargs)  # noqa: E501
        else:
            (data) = self.close_operation_with_http_info(session_id, **kwargs)  # noqa: E501
            return data

    def close_operation_with_http_info(self, session_id, **kwargs):  # noqa: E501
        """Close session  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.close_operation_with_http_info(session_id, async_req=True)
        >>> result = thread.get()
        ...
        if ('session_id' not in params or
            ...
            raise ValueError("Missing the required parameter `session_id` when calling `close_operation`")  # noqa: E501
    ...
    def create_operation(self, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param object body:
        :return: OperationCreateResponce
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
    ...
    def create_operation_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='OperationCreateResponce',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
